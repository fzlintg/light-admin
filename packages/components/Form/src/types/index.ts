...
interface _CustomComponents {
  ...
  StrengthMeter: ExtractPropTypes<
    (typeof import('@c/StrengthMeter/src/StrengthMeter.vue'))['default']
  >;
  Upload: ExtractPropTypes<(typeof import('@c/Upload/src/BasicUpload.vue'))['default']>;
  ImageUpload: ExtractPropTypes<
    (typeof import('@c/Upload/src/components/ImageUpload.vue'))['default']
  >;
  IconPicker: ExtractPropTypes<(typeof import('@c/Icon/src/IconPicker.vue'))['default']>;
  ApiTransfer: ExtractPropTypes<(typeof import('../components/ApiTransfer.vue'))['default']>;
  CropperAvatar: ExtractPropTypes<(typeof import('@c/Cropper/src/CropperAvatar.vue'))['default']>;
  BasicTitle: ExtractPropTypes<(typeof import('@c/Basic/src/BasicTitle.vue'))['default']>;
  InputCountDown: ExtractPropTypes<
    (typeof import('@c/CountDown/src/CountdownInput.vue'))['default']
  >;
}
